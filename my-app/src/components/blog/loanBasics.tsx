        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {[
            ...
            },
            {
              ...
              title: "Interest Rate",
              description:
                "The percentage of principal charged by the lender for borrowing",
            },
            {
            ...
            {[
              {
                title: "Home Loan",
                description:
                  "Long-term financing for purchasing residential property. Usually has lower interest rates due to property collateral.",
                tenure: "15-30 years",
              ...
              },
              {
                title: "Car Loan",
                description:
                  "Financing specifically for purchasing vehicles. The vehicle serves as collateral for the loan.",
                tenure: "1-7 years",
              ...
              },
              {
                title: "Personal Loan",
                description:
                  "Unsecured loans for various purposes. Higher interest rates due to no collateral requirement.",
                tenure: "1-5 years",
              ...
              },
              {
                ...
                description:
                  "Specifically for funding education expenses. Often comes with special terms for students.",
                tenure: "5-15 years",
              ...
              },
              {
                title: "Business Loan",
                description:
                  "For business purposes like expansion, inventory, or working capital needs.",
                tenure: "1-10 years",
                interestRange: "11% - 20%",
              },
              {
                title: "Gold Loan",
                description:
                  "Loans with gold as collateral. Quick processing and lower interest rates.",
                tenure: "1-3 years",
